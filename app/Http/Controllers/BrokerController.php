...
class BrokerController extends Controller
{
    public function index()
    {
        ...
        return view('backend.broker.deal-list', ['deals' => $deals]);
    }
    ...
    public function deals_detail($id)
    {
        ...
        return view('backend.broker.detail', [
            'deal' => $deal,
            'dealMeta' => $dealMeta,
        ]);
    }
    ...
    public function viewDeal($id)
    {
        ...
        return view('backend.broker.folder-list', [
            'deal' => $deal,
            'folders' => $foldersData,
        ]);
    }
    ...
    public function viewFolderFiles($id, GcsStorageService $gcsStorageService)
    {
        ...
        return view('backend.broker.files-list', compact('files', 'id'));
    }
}
