                    ...
                    <div class="modal-body" style="max-height: 400px; overflow-y: auto;">
                        ...
                        <ol>
                            <li><strong>No Disclosure.</strong> The Recipient (Buyer) will hold the Confidential information
                                ...
                                disclose the Confidential information to any person or entity without the prior written
                                consent
                            ...
                            <li>The Recipient will not to contact the landlord, employees, suppliers, franchisor or
                                customers of
                            ...
                            <li><strong>Non Circumvention.</strong> For a period of two (2) years after the date this
                                ...
                                Recipient will not attempt to do business with, or otherwise solicit any business contacts
                                found
                                or otherwise referred by Seller to Recipient for the purpose of circumventing, the result of
                                which shall be to prevent the Seller from realizing or recognizing a profit, fees, or
                                otherwise,
                                without the specific written approval of the Seller. If such circumvention shall occur the
                                Seller shall be entitled to any commissions due pursuant to this Agreement or relating to
                                such
                                transaction.
                            </li>
                            <li><strong>Relationship of Parties.</strong> Neither party has an obligation under this
                                Agreement to purchase any
                                service or item from the other party, or commercially offer any products using or
                                incorporating
                                the Confidential information. This Agreement does not create any agency, partnership or
                                joint
                                venture. David Moore & Partners is compensated from any transaction that results between the
                                buyer and the seller.</li>
                            <li><strong>No Warranty and Due Diligence.</strong> The Recipient acknowledges and agrees that
                                the Confidential
                                Information is provided on an “AS IS” basis. David Moore & Partners makes no warranties,
                                express
                                or implied, with respect to the confidential information and hereby expressly disclaims any
                                and
                                all implied warranties of merchantability and fitness for a particular purpose. In no event
                                shall David Moore & Partners be liable for any direct, indirect, special or consequential
                                damage
                                in connection with or arising out of the performance, use , or inaccuracies of any portion
                                of
                            ...
                            <li>Due to the sensitive nature of the financial records and the potential effects violations of
                                ...
                                Dollars ($25,000.00) per violation. Violation of this Agreement will cause the Seller to
                                incur
                                substantial economic damages and losses of types and in amounts which are impossible to
                                compute
                                and ascertain with certainty as a basis for recovery by the Seller of actual damages. The
                                above
                                liquidated damages represent a fair, reasonable, and appropriate estimate of the damage
                                likely
                                ...
                                damages are not intended as a penalty, and Buyer shall pay them to Seller without limiting
                                David
                                Moore & Partners’ or the Seller’s right to terminate this Agreement as provided elsewhere.
                                Examples of a breach of this Agreement include but are not limited to: Disclosing the
                                company
                            ...
                            <li>The respective obligations of the parties under this Agreement shall survive for a period of
                                two
                                (2) years following the date hereof.
                            </li>
                        </ol>
                        <p>Smaller transactions do not always have a full set of financials. Small Companies do not have
                            CFO’s
                        ...
                        <p><strong> We handle transactions differently than some brokers. We do not present buyers to
                                sellers
                                ...
                                (such as
                                tax returns, customer lists, etc) without a letter of intent. We require in person site
                                visits
                                prior to accepting any letters of intent. While we understand this may prevent some buyers
                                from
                                moving forward, our intent is to protect our client’s sensitive information and prevent
                                people
