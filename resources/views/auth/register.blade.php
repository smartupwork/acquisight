                        ...
                        <div class="card">
                            <div class="card-body p-0 bg-black auth-header-box rounded-top">
                                <div class="text-center p-3">
                                    ...
                                    <p class="text-muted fw-medium mb-0">Sign Up to continue to Rizz.</p>
                                </div>
                            </div>
                            <div class="card-body pt-0">
                                ...
                                @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" name="password_confirmation" id="userconfirmpassword" placeholder="Confirm password">
                                    </div>
